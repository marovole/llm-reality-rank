...
> Snapshot: `2026-05-beta` · Release stage: Alpha / 不完整覆盖 · Generated: 2026-05-04

这是一篇面向中文高阶 AI 用户、开发者和创作者的公开方法论草稿。它使用的表格和结论只来自 reviewed snapshot `2026-05-beta`；当前快照是一个小规模 Alpha 种子，不是正式综合排名，也不是对所有主流模型的全面最终结论。
...
- Snapshot manifest: [`snapshots/llm-reality-rank/2026-05-beta/manifest.json`](../snapshots/llm-reality-rank/2026-05-beta/manifest.json)
- Score records: [`snapshots/llm-reality-rank/2026-05-beta/scores.json`](../snapshots/llm-reality-rank/2026-05-beta/scores.json)
- Source evidence: [`snapshots/llm-reality-rank/2026-05-beta/source-evidence.json`](../snapshots/llm-reality-rank/2026-05-beta/source-evidence.json)
...
- `ceval` — [C-Eval](https://cevalbenchmark.com/static/leaderboard.html)
- `livebench` — [LiveBench](https://livebench.ai/)
- `opencompass_llm` — [OpenCompass LLM Leaderboard](https://rank.opencompass.org.cn/leaderboard-llm-v2)
- `superclue` — [SuperCLUE](https://superclueai.com/)
- `swe_bench_verified` — [SWE-bench Verified](https://www.swebench.com/)

数据观察日期范围：`2026-05-03` 到 `2026-05-03`。行数：raw `24`，model scores `9`。

## Article-ready exports

下列表格由脚本可复现生成，来源均为同一个 reviewed snapshot：

- [Overall reviewed alpha table / 综合 Alpha 表](../outputs/llm-reality-rank/article-exports/2026-05-beta/overall.md)
- [Coding reviewed alpha table / AI 编程 Alpha 表](../outputs/llm-reality-rank/article-exports/2026-05-beta/coding.md)
- [Chinese reviewed alpha table / 中文能力 Alpha 表](../outputs/llm-reality-rank/article-exports/2026-05-beta/chinese.md)
- [Value/API reviewed alpha table / 性价比与 API Alpha 表](../outputs/llm-reality-rank/article-exports/2026-05-beta/value-api.md)
- [Multimodal reviewed alpha table / 多模态 Alpha 表](../outputs/llm-reality-rank/article-exports/2026-05-beta/multimodal.md)
- [Agent reviewed alpha table / Agent Alpha 表](../outputs/llm-reality-rank/article-exports/2026-05-beta/agent.md)
